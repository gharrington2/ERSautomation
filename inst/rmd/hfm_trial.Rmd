...
There were `r get("this_month_df_institutions", envir = env1)` people estimated to be sleeping rough over the month in `r this_month` who had left an institution (`r round(((get("this_month_df_institutions", envir = env1))/get("this_month_df_month", envir = env1))*100, digits = 0)`% of the total number of people sleeping rough over the month). Of these:
...
**Figure 8: Number of nights people estimated to have been seen sleeping rough over the last 6 months June 2024 to `r this_month` (B2)**
