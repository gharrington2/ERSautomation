...
### Rare (R1)
**`r march24_month_eng`** people sleeping rough over the month in March 2024 - up (`r round(abs((march24_month_eng - march23_month_eng)/march23_month_eng)*100), digits = 0)`)% on March last year, and up
