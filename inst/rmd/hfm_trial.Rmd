...
* `r get("this_month_df_1_night", envir = env1)` had been seen sleeping rough 1 night over the previous 6 months 

* `r get("this_month_df_2_nights", envir = env1)` had been seen sleeping rough 2 nights over the previous 6 months  

* `r get("this_month_df_3_5_nights", envir = env1)` had been seen sleeping rough 3 to 5 nights over the previous 6 months 

* `r get("this_month_df_6_10_nights", envir = env1)` had been seen sleeping rough 6 to 10 nights over the previous 6 months 

* `r get("this_month_df_10_more_nights", envir = env1)` had been seen sleeping rough more than 10 nights over the previous 6 months 

* `r get("this_month_df_unknown_nights", envir = env1)` had been seen sleeping rough an unknown number of nights over the previous 6 months 
...
Of these, (when further filtered to exclude those who hadn't been seen in more than 5 years) `r get("this_month_df_prev_in_accomm", envir = env1)` (`r round((get("this_month_df_prev_in_accomm", envir = env1) /  get("this_month_df_returners", envir = env1))*100, digits = 0)`%) were returning to sleeping rough after moving into settled accommodation in the preceding 12 months. 
