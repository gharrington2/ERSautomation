...
England <- sf::st_read("~/GitHub/ERSautomation/inst/rmd/England_map_2023/LAD_MAY_2023_UK_BGC_V2.shp")

England <- England %>%
  dplyr::left_join(df_snapshot,  by = join_by(LAD23CD))
...
tmap::tmap_save(England_map, "~/GitHub/ERSautomation/inst/rmd/images/England_map.png", width=1000, height=1000, asp=0)
tmap::tmap_save(England_map, "~/GitHub/ERSautomation/inst/rmd/images/England_map.svg", width=2000, height=2000, asp=0)
...
London_join <- England %>%
  dplyr::left_join(London,  by = join_by(LAD23CD))
...
tmap::tmap_save(London_map, "~/GitHub/ERSautomation/inst/rmd/images/London_map.png", width=2000, height=2000, asp=0)
tmap::tmap_save(London_map, "~/GitHub/ERSautomation/inst/rmd/images/London_map.svg", width=2000, height=2000, asp=0)
...
England <- England %>%
  dplyr::left_join(df_month_rate,  by = join_by(LAD23CD))
...
tmap::tmap_save(England_map_rate, "~/GitHub/ERSautomation/inst/rmd/images/England_map_rate.png", width=2000, height=2000, asp=0)
tmap::tmap_save(England_map_rate, "~/GitHub/ERSautomation/inst/rmd/images/England_map_rate.svg", width=2000, height=2000, asp=0)
...
tmap::tmap_save(London_map_rate, "~/GitHub/ERSautomation/inst/rmd/images/London_map_rate.png", width=2000, height=2000, asp=0)
tmap::tmap_save(London_map_rate, "~/GitHub/ERSautomation/inst/rmd/images/London_map_rate.svg", width=2000, height=2000, asp=0)
