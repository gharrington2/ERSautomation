...
input_path <- "Q:/ASCT/P005 Homelessness/008 Rough Sleeping/RS MI R/New monthly tables script/Git_Version/Publication_tables/Publication_tables241016.xlsx"
...
::: {custom-style="GreyBox"}
**Date of next publication**: It is expected that the next quarterly publication of monthly data up to September, will be published in February 2025.
::: 
...
* The number of people sleeping rough over the course of the month who were accommodated by the end of the month, known as R2. 
...
* The number of people returning to sleeping rough after moving into settled accommodation, known as NR2. 
...
knitr::include_graphics(system.file("rmd/images/figure_2.svg",  package = "ERSautomation"))
...
knitr::include_graphics(system.file("rmd/images/figure_4.svg", package = "ERSautomation"))
...
The majority of people sleeping rough over the month of `r this_month` (X, X%) had been seen sleeping rough 'only once' in the previous 6 months. 'This has been consistent for every month' since data collection started in June 2024, with '10+ nights' being the second most common category for number of nights seen sleeping rough over the last 6 months, with 'X' people ('X%' of all those sleeping rough over the month).  
...
knitr::include_graphics(system.file("rmd/images/figure_5.svg",  package = "ERSautomation"))
...
knitr::include_graphics(system.file("rmd/images/England_map.svg",  package = "ERSautomation"))
knitr::include_graphics(system.file("rmd/images/London_map.svg",  package = "ERSautomation"))
...
# 
knitr::include_graphics(system.file("rmd/images/England_map_rate.svg", package = "ERSautomation"))
knitr::include_graphics(system.file("rmd/images/London_map_rate.svg", package = "ERSautomation"))
