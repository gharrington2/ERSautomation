...
# Automatically apply custom_format to all inline R code
...
figure_2 <- ggplot(donut_data, aes(ymax=ymax, ymin=ymin, xmax=5, xmin=3.25, fill=Institutions)) +
  geom_rect() +
  geom_text(data=subset(donut_data, Institutions != "UK armed forces"), aes(x=4, y=labelPosition, label=label), size=4, color = "white") +
  geom_text(data=subset(donut_data, Institutions == "UK armed forces"), aes(x=5.75, y=custom_labelPosition, label=label), size=4, color = "#767171") +
  geom_segment(data=subset(donut_data, Institutions == "UK armed forces"), aes(x=4, y=original_label_position, xend=5.45, yend=custom_labelPosition), color="#767171", size=01) +
  coord_polar(theta="y") +
  xlim(c(0, 6)) +
  ...
  annotate("text", x = 1, y = 0, label = total_value, size = 18, color = "#012169", fontface = "bold")+
