...
England_map <- England %>%
  tm_shape() +
  tm_fill("snapshot", style = "cont", breaks = c(0,5,10,15,20),
          labels = c("0","5","10","15","20+"),
          palette = c("#EFF3FF","#BDD7EE", "#6BAED6",  "#3182BD", "#08519C"),
          title = "People sleeping \nrough per 100k \npopulation") +
  tm_borders(lwd = 0.7, lty = "solid", alpha = 1) +
  tm_style("col_blind") +
...
tmap_save(England_map, "~/GitHub/ERSautomation/inst/rmd/images/England_map.png", width=1000, height=1000, asp=0)
...
London_map <- London_join %>%
  tm_shape() +
  tm_fill("snapshot.y", style = "cont", breaks = c(0,5,10,15,20),
          labels = c("0","5","10","15","20+"),
          palette = c("#EFF3FF","#9FADCD", "#788AB3",  "#50679B", "#012169"),
          title = "People",
          legend.show = FALSE) +
