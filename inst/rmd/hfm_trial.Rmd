...
options(digits = 10)   # Limits the number of digits
...
max_date <- max(new_df$Date)
 ...
 figure_1 <- ggplot(new_df, aes(x = Date)) +
   ...
   scale_y_continuous(breaks = seq(0,3500, by = 500),labels = comma, limits = c(0,3500))+
   scale_x_date(labels = scales::date_format("%b"), date_breaks = "1 month", limits = c(min_date, max_date), expand = c(0, 8)) +
   theme(
  ...
  geom_text(data = new_df[1, ], aes(x = Date, y = `New month`, label = "        New people sleeping\n rough over the month (P1)"),
            color = "#95B3D7", vjust = -6.4, hjust = -2.1, size = 3.5)
print(figure_1)
...
figure_3 <- ggplot(institutions_data, aes(x = Date)) +
  ...
  dluhc_style(size = 1.5)+
  scale_y_continuous(breaks = seq(0,500, by = 100),labels = comma, limits = c(0,500))+
  theme(
    axis.text.x = element_text(angle = 90, hjust = 1, vjust = 0.5, family = "Arial", color = "#7F7F7F", size = 11),
    axis.text.y = element_text(family = "Arial", color = "#7F7F7F", size = 10),
    text = element_text(family = "Arial", color = "#7F7F7F"),
...
```{r 4-Figure 4 R1, include=FALSE}
 ...
 figure_4 <- ggplot(df, aes(x = Date)) +
   ...
   scale_x_date(labels = scales::date_format("%b"), date_breaks = "1 month", expand = c(0, 8)) +
   theme(
    axis.text.x = element_text(angle = 90, hjust = 1, vjust = 0.5, family = "Arial", color = "#7F7F7F", size = 11),
    axis.text.y = element_text(family = "Arial", color = "#7F7F7F", size = 10)
  ) +
  ...
  geom_text(data = df[1, ], aes(x = Date, y = `Month`, label = "   Number of people \n sleeping rough over \n       the month (R1)"),
            color = "#95B3D7", vjust = -3.3, hjust = -2.25, size = 3.5)
...
figure_5 <- ggplot(comb_last_year_long, aes(x = Date, y = Value, fill = Category)) +
  ...
  dluhc_style(size = 1.5) +
  scale_y_continuous(breaks = seq(0,9000, by = 1000),labels = comma, limits = c(0, 8000))+
  scale_x_date(labels = scales::date_format("%b %Y"), date_breaks = "1 month", expand = c(0,0)) +
  theme(
    axis.text.x = element_text(angle = 90, hjust = 1, vjust = 0.5, family = "Arial", color = "#7F7F7F", size = 11),
    axis.text.y = element_text(family = "Arial", color = "#7F7F7F", size = 10)
  ) +
...
tmap_save(London_map, "~/GitHub/ERSautomation/inst/rmd/images/London_map.png", width=2000, height=2000, asp=0)
tmap_save(London_map, "~/GitHub/ERSautomation/inst/rmd/images/London_map.svg", width=2000, height=2000, asp=0)
