...
input_path <- "Q:/ASCT/P005 Homelessness/008 Rough Sleeping/RS MI R/New monthly tables script/Git_Version/Publication_tables/Publication_tables241004.xlsx"
...
#### Non-recurring (NR2)
**`r get("this_month_df_prev_in_accomm", envir = env1)`** people sleeping rough over the month in `r this_month` who are returning to sleeping rough who had previously moved into settled accommodation within the last 12 months (`r round(((get("this_month_df_prev_in_accomm", envir = env1))/get("this_month_df_prev_in_accomm", envir = env1))*100, digits = 0)`% of total people sleeping rough over the month)
...
In May 2023, the Ministry of Housing, Communities and Local Government launched a new framework with a new set of metrics to better understand how far rough sleeping is **prevented** wherever possible, and where it does occur it is **rare**, **brief**, and **non-recurring**. This is the third quarterly publication of the framework and covers monthly information up to `r this_month`. 
...
This new data framework will be relevant to people working locally to end rough sleeping and is an important step towards driving better outcomes for vulnerable people.  

There are eight core indicators of the framework, including three which were rolled out nationally in June 2024 and will be reported on in future publications. This publication provides information about the first five core indicators, which were rolled out nationally in May 2023, for all local authorities in England up to June 2024. These are:
...
* The Rough Sleeping Data Framework includes 3 additional indicators which were rolled out nationally in June 2024 and will be available alongside the other indicators in the next quarterly publication. These indicators include the number of people sleeping rough who have moved into accommodation, known as R2, the average length of time sleeping rough, known as B2 and the number of people sleeping rough who had previously moved into settled accommodation, known as NR2.
...
The management information is collected via a regular survey to local authorities, which began in May 2020. Local authorities were asked to provide data underpinning the new framework indicators from May 2023, although some indicators have been collected for longer as they were already part of the rough sleeping management information collection. All local authorities are requested to complete the survey.
...
### 9.6 Dates of future publication

The publication dates for future rough sleeping management information is as follows:

*	Rough sleeping Data Framework, September 2024, due to be published November/December 2024
